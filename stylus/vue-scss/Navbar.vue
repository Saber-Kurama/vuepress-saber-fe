...
@function getVar($var) {
  ...
  position: relative;
  margin-left: 10px;.user-dropdown {
    display: flex;
    align-items: center;
    justify-content: center;
    padding-right: 10px;&:hover {
      .dropdown {
        opacity: 1;
        visibility: visible;
      }
      ...
      transition: all 0.25s ease;.dropdown-content {
        width: 160px;
    ...
    padding-right: 17px;
    transition: all 0.25s ease;
    box-shadow: 0px 0px 0px 0px getVar(theme-color);&:hover {
      box-shadow: 0px 5px 15px -5px getVar(theme-color);
      transform: translate(0, -4px);
    }
  }
  ...
  transition: all 0.25s ease;&.transparent {
    background: transparent;
  }&.fixed {
    border-radius: 0px;
    background: getVar(theme-layout);.btn-login {
      border-radius: 10px;
    }
  }
  a, span, img {
    ...
    display: flex;
    align-items: center;
    justify-content: center;.search-box {
      flex: 0 0 auto;
      vertical-align: top;
    }
  }
...
@media (max-width: 1000px) {
  .navbar {
    ...
    padding-left: 2.5rem;
    display: flex;
    justify-content: space-between;.home-link {
      position: relative;
      padding-left: 0px;
      margin-left: 25px;
    }.external-links-search {
