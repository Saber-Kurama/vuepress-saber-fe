...
@function getVar($var) {
  ...
  .dropdown-title {
    ...
    border-color: transparent;.nav-link {
      i.bx {
    ...
    .dropdown-item {
      ...
      h4 {
        ...
        padding: 0;
        list-style: none;.dropdown-subitem {
          font-size: 0.9em;
        }
      }
      a {
        ...
        transform: translate(0) !important;&::after {
          content: "";
          width: 5px;
          height: 5px;
          position: absolute;
