...
@-webkit-keyframes componentAnimate {
  0% {
...
@-moz-keyframes componentAnimate {
  0% {
    transform: translate(0px);
  }30% {
    transform: translate(0, -10px);
...
@keyframes componentAnimate {
  ...
  *::placeholder {
  ...
  transition: all 0.25s ease;&.vuesax-logo {
    border-radius: 50px;
    img {
      width: 50%;
      z-index: 100;
  ...
  justify-content: center;
  transform: scale(0.8);
  z-index: 100;.content-components {
    position: relative;
    width: 1100px;
    height: 100%;.component13 {
      width: 300px;
      padding: 15px;
      background: getVar(theme-layout);
      border-radius: 20px;
      ...
      animation: componentAnimate 18s infinite ease;&:hover {
        box-shadow: 0px 0px 0px 0px rgba(0, 0, 0, 0.1);
        transform: translate(0, 5px);
      }.vs-input-parent {
        width: calc(100% - 50px);/deep/input {
          width: 100% !important;
        }
      }
      ul {
      ...
      header {
        ...
        input {
          ...
          width: calc(100% - 50px);
          border-radius: 14px;
          transition: all 0.25s ease;&:focus {
            padding-left: 25px;
          }
        }
      }
      ...
      left: 0px;
      transition: all 0.25s ease;
      animation: componentAnimate 20s infinite ease alternate;/deep/input {
        background: getVar(theme-layout);
        padding: 10px 15px;
        box-shadow: 0px 8px 20px 0px rgba(0, 0, 0, 0.04);
        width: 275px;&:focus {
          padding-left: 20px;~ button {
            transform: translate(-5px, -9px);
            box-shadow: 0px 10px 20px -10px getColor('primary', 0.8);
          }
        }
      }
      button {
        ...
        height: 40px;
        margin: 0px;
        box-shadow: 0px 0px 0px 0px getColor('primary', 0.8);
        i {
          font-size: 1rem;
        }
      }
      ...
      border-radius: 15px;
      user-select: none;
      animation: componentAnimate 16s infinite ease reverse;.liquid {
        width: 20px;
        background: getVar(theme-layout);
        height: 15px;
        right: 30px;
        ...
        z-index: 200;
        opacity: 0;
        transition: all 0.25s ease;&:after {
          content: '';
          position: absolute;
          top: -5px;
          left: -20px;
      ...
      ul {
        ...
        justify-content: center;
        padding-left: 0px;
        box-shadow: 0px 8px 20px 0px rgba(0, 0, 0, 0.04);&.active {
          opacity: 1;
          visibility: visible;
      ...
      box-shadow: 0px 8px 20px 0px rgba(0, 0, 0, 0.04);
      transition: all 0.25s ease;
      animation: componentAnimate 14s infinite ease;&:hover {
        box-shadow: 0px 0px 0px 0px rgba(0, 0, 0, 0.1);
        transform: translate(0, 5px);
      }
      button {
        margin: 15px;&:first-child {
          i {
      ...
      header {
        ...
        input {
          ...
          box-shadow: 0px 0px 0px 0px rgba(0, 0, 0, 0.05);
          font-size: 0.8rem;
          color: getVar(theme-color);&::selection {
            background: transparent;
          }
        }
        i {
      ...
      transition: all 0.25s ease;
      animation: componentAnimate 22s infinite ease reverse;&:hover {
        box-shadow: 0px 0px 0px 0px rgba(0, 0, 0, 0.1);
      ...
      footer {
        ...
        i {
          ...
          font-size: 1.4rem;
          text-shadow: 0px 4px 15px getColor('danger', 0.4);
        }
      }.con-img {
        width: 230px;
        height: 250px;
      ...
      box-shadow: 0px 15px 30px -8px rgba(0, 0, 0, 0.08);
      transition: all 0.25s ease;
      animation: componentAnimate 15s infinite ease;&:hover {
        box-shadow: 0px 0px 0px 0px rgba(0, 0, 0, 0.1);
        transform: translate(0, 7px);
      }
      footer {
      ...
      header {
        ...
        button {
          ...
          i {
            ...
            i {
              color: getColor('primary');
              text-shadow: 0px 4px 15px getColor('primary', 0.4);
              margin-right: 5px;
            }
          }
        }
      ...
      transition: all 0.25s ease;
      z-index: 200;
      animation: componentAnimate 18s infinite ease alternate;&:hover {
        box-shadow: 0px 0px 0px 0px rgba(0, 0, 0, 0.1);
        transform: translate(0, 7px);
      }.con-load {
        width: 85px;
        ...
        box-shadow: 0px 0px 20px 0px getColor('primary', 0.1), inset 0px 0px 20px 0px getColor('primary', 0.1);
        border-left: 8px solid getColor('primary', 0.1);
        transform: rotate(45deg);
      ...
      box-shadow: 0px 15px 30px -8px rgba(0, 0, 0, 0.08);
      transition: all 0.25s ease;
      animation: componentAnimate 13s infinite ease reverse;&:hover {
        box-shadow: 0px 0px 0px 0px rgba(0, 0, 0, 0.1);
        transform: translate(0, 7px);.con-img {
      ...
      justify-content: center;
      transition: all 0.25s ease;
      animation: componentAnimate 21s infinite ease alternate;.con-switch {
        width: 65px;
        height: 35px;
        background: getVar(theme-layout);
        ...
        margin: 10px 12px;
        cursor: pointer;
        transition: all 0.25s ease;&:active {
          &.active {
            .circle {
          ...
          background: getColor('primary');.circle {
      ...
      padding: 35px;
      transition: all 0.25s ease;
      animation: componentAnimate 19s infinite ease reverse;&:hover {
        box-shadow: 0px 0px 0px 0px rgba(0, 0, 0, 0.1);
        transform: translate(0, 7px);
      }
      img {
      ...
      left: 0px;.con-text {
        ...
        img {
          ...
          right: -6px;
          background: getColor('danger');
          box-shadow: 0px 4px 10px 0px getColor('danger', 0.6);
          width: 20px;
          height: 20px;
          color: #fff;
          font-weight: bold;
...
@media (max-width: 760px) {
  .con-components {
    display: none;.content-components {
      left: -18%;
    }
  }
}
