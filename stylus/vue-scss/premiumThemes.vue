...
@function getVar($var) {
  ...
  .con-themes {
    header {
      footer {
        button {
          box-shadow: none !important;&:last-child {
  ...
  header {
    ...
    footer {
      ...
      button {
        ...
        border-radius: 18px;.vs-button__content {
          padding: 13px 30px;
        }
      }
    }
  ...
  img.bg {
    ...
    border: 6px solid getVar(theme-layout);&:hover {
      transform: translate(0, -20px);
      box-shadow: 0px 20px 20px -10px rgba(0, 0, 0, 0.15);~ img:not(.svg) {
        opacity: 1;
