...
@function getVar($var) {
  ...
  flex-direction: column;.con-form {
    width: 400px;
  }
  h4 {
    padding: 0px;
  ...
  #mc_embed_signup_scroll {
    ...
    input {
      ...
      box-shadow: 0px 8px 40px -5px rgba(0, 0, 0, 0.09);&[type="email"] {
        width: 400px;
        margin-right: -30px;
        padding-right: 30px;
        ...
        position: relative;
        min-width: 250px;
        background: getVar(theme-layout);&:focus {
          box-shadow: 0px 5px 10px 0px rgba(0, 0, 0, 0.1);
          transform: translate(0, 4px);~ .clear {
            input {
              box-shadow: 0px 0px 0px 0px getColor('primary', 0.6);
        ...
        color: #fff;
        box-shadow: 0px 10px 20px -10px getColor('primary', 0.6);
        cursor: pointer;
        position: relative;
        z-index: 200;
        margin-left: -85px;
        transform: translate(0%, -10px);&:hover {
          box-shadow: 0px 10px 20px -10px getColor('primary', 0.6) !important;
  ...
  border-radius: 0px 30px 0px 0px;.footer__uls {
    display: flex;
