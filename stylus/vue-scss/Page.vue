...
@media (max-width: 1240px) {
  ...
  table {
    ...
    padding: 0px 40px !important;&.con-table {
    ...
    h1 {
      ...
      li {
        button {
          ...
          justify-content: center;
          transition: all 0.25s ease;
          color: getVar(theme-color);&:hover {
            ul {
              opacity: 1;
              visibility: visible;
              transform: translate(0, calc(100% - 20px));
  ...
  margin-top: 50px;
  font-size: 0.85rem;  @extend $wrapper;
  padding-top: 1rem;
  padding-bottom: 1rem;
  overflow: auto;.edit-link {
...
@media (max-width: 600px) {
  .page-nav {
    .inner {
      ...
      span {
        ...
        span {
          ...
          width: 40px;
          height: 40px;
          border-radius: 0px 10px 0px 0px;~ .next {
    ...
    pointer-events: none;
    margin: 0px;
    border-radius: 15px 0px 0px 0px;&.active {
      opacity: 1;
      pointer-events: auto;
    }
  }.header-page {
    table {
      ...
      height: 120px;
      padding-right: 30px !important;.flex-header {
    ...
    &.fixed {
      .header__content {
        height: 52px !important;.flex-header {
          #header-title {
...
@media (max-width: 600px) {
  .page {
    ~ .carbon-ads {
      background: transparent;#carbonads {
        background: transparent;
        border-radius: 0px;
        margin-top: 0px;
        img {
