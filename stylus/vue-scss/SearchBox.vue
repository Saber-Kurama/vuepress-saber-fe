...
@function getVar($var) {
  ...
  margin-right: 1rem;
  margin-right: 0px;
  position: relative;&.showSuggestions {
    .con-input {
      input {
  ...
  input {
    ...
    padding-left: 20px;
    opacity: 1;
    border-radius: 14px 5px 14px 14px;&::placeholder {
      color: getVar(theme-color);
    }&:focus {
      width: 25rem;
      cursor: auto;~ svg {
...
@media (max-width: 500px) {
  ...
  input {
    ...
    color: transparent !important;&:focus {
      width: 100%;
